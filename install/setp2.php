...
<table class="tb" style="margin:20px 0 20px 55px;width:90%;">
	...
	<tr>
		<td>./public/img</td><td class="w pdleft1">可写</td>
		<?php if (iswriteable('../public/img')) {?>
	...
	<tr>
		<td>common.php</td><td class="w pdleft1">可写</td>
		<?php if (is_writable('../common.php')) {?>
		<td class="w pdleft1">支持</td>
		<?php } else {?>
		<td class="nw pdleft1">不支持</td>
		<?php }?>
	...
	<tr>
		<td>./caches</td><td class="w pdleft1">可写</td>
		<?php if (is_writable('../caches')) {?>
		<td class="w pdleft1">支持</td>
		<?php } else {?>
		<td class="nw pdleft1">不支持</td>
		<?php }?>
