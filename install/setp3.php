...
<tr><th class="tbopt" align="left">&nbsp;网站站名:</th>
<td><input type="text" name="siteName" value="论坛" size="35" class="txt"></td>
<td></td>
</tr>

<tr><th class="tbopt" align="left">&nbsp;数据库名:</th>
<td><input type="text" name="dbName" value="bbs" size="35" class="txt"></td>
<td></td>
</tr>
...
<td><input type="text" name="pwd" value="" size="35" class="txt"></td>
<td></td>
</tr>

<tr><th class="tbopt" align="left">&nbsp;数据表前缀:</th>
<td><input type="text" name="prefix" value="bbs_" size="35" class="txt"></td>
