...
<body>
	...
	<div class="cidMan">
	<div class="cm_t"><h2 style="float: left">回复管理</h2>
	<nav aria-label="Page navigation" id="page" style="float: right;margin-right:40px">
  <ul class="pagination">
    <li>
      <a href="/admin/replyManage.php?page=<?=$prev;?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    <?php for($i=1;$i<$count+1;$i++):?>
    <li><a href="/admin/replyManage.php?page=<?=$i;?>"><?=$i;?></a></li>
    <?php endfor;?>
    <li>
      <a href="/admin/replyManage.php?page=<?=$next;?>" aria-label="Next">
	...
	<div>
		<form action="/admin/replyDel.php" method="post">
		<table class="cidMan">

		<!-- 开始遍历 -->
		
			<tr><th></th><th>回复内容</th><th>板块</th><th class="checkbox">作者</th><th>最后发表</th></tr>
			<!-- 大板块开始 -->
			<?php if($newDetails):?>
