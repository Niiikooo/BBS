	...
	<div id="container">
		...
		<div id="search">
			<div class="search_top">
				<ul>
					<li style="" class="search_sy">首页</li>
					<li class="dn"></li>
					<li style="" class="search_js">PHP技术交流</li>
					<li class="dn"></li>
					<li style="" class="search_cx">程序人生</li>
				</ul>
			</div>
		...
		<div id="main">
			...
			<div class="main-mod">
				...
				<div class="main-mod-main">
					<div class="mod-left">
						...
						<p><a href="#">内核源码</a><br/>版主：test001</p>
			...
			<!-- 第二个板块开始 -->
				...
				<!-- 小版块完 -->
					...
					<div class="main-mod-main bt" style=";">
					<div class="mod-left">
						<a href="#"><img src="img/forum.gif" alt=""></a>
						<p><a href="#">内核源码</a><br/>版主：test001</p>
					</div>
